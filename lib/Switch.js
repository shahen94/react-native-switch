...
export class Switch extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      activeTextColor: props.value ? "#fff" : "transparent",
      inActiveTextColor: !props.value ? "#fff" : "transparent"
    };
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      activeTextColor: nextProps.value ? "#fff" : "transparent",
      inActiveTextColor: !nextProps.value ? "#fff" : "transparent"
    });
  ...
  handleSwitch() {
    ...
    this.setState({
      activeTextColor: value ? "#fff" : "transparent",
      inActiveTextColor: !value ? "#fff" : "transparent"
    });
            ...
            {renderInActiveText && (
              <Text
                style={[
                  ...
                  styles.paddingLeft,
                  inactiveTextStyle,
                  { color: this.state.inActiveTextColor }
                ]}
              >
                {inActiveText}
              </Text>
